---
description: >-
  The Item Example showcases which authoring components are needed to set up a
  new item as well as how to localize it. In this case the example is adding a
  new sword via a mod.
---
